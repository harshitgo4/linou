...
const Four = () => {
  return (
    ...
    >
      ...
      >
        <img
          src={img4} // Replace with the actual path to your image
          alt="User Avatar"
    ...
    >   <Text color={'whitesmoke'} fontFamily={'Plus Jakarta Sans'}> I love how user-friendly this app is! It's so easy to add events and set reminders!</Text>
        <Text fontFamily={'Plus Jakarta Sans'} color={'GrayText'}>Adam, entrepreneur </Text>
    ...
    <Box
      ...
      >
        <img
          src="https://framerusercontent.com/images/CPGgYEBeFy4gDXe5dDzh1qjQG1w.png" // Replace with the actual path to your image
          alt="User Avatar"
          style={{ width: '100%', height: '100%', objectFit: 'cover' }}
        />
      </Box>
